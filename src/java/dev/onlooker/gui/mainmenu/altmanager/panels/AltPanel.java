package dev.onlooker.gui.mainmenu.altmanager.panels;

import dev.onlooker.Client;
import dev.onlooker.gui.Screen;
import dev.onlooker.gui.mainmenu.altmanager.Panel;
...
public class AltPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        setWidth(sr.getScaledWidth() - (getX() + 80));
        setHeight(sr.getScaledHeight() - (16 + 125));
        setY(75);
    ...
    public static class AltRect implements Screen {
        ...
        public void drawAltHead(float x, float y, float size) {
            ...
            mc.getTextureManager().bindTexture(alt.head != null ? alt.head : new ResourceLocation("OnLooker/Images/X-Steve.png"));
