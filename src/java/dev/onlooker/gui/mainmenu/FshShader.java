...
public class FshShader {
    private final int programId;
    private final int timeUniform;
    private final int mouseUniform;
    private final int resolutionUniform;

    public FshShader(String fragmentShaderLocation) throws IOException {
        int program = GL20.glCreateProgram();
        GL20.glAttachShader(program, this.createShader(FshShader.class.getResourceAsStream("/assets/minecraft/OnLooker/Shaders/passthrough.vsh"), 35633));
        GL20.glAttachShader(program, this.createShader(FshShader.class.getResourceAsStream(fragmentShaderLocation), 35632));
