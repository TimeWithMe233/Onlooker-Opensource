...
import dev.onlooker.gui.GuiEvents;
...
import dev.onlooker.utils.misc.StringUtils;
...
public class SettingsPanel extends Panel {
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        if (HUDMod.watermarkTheme.is("Light")) {
            ...
            categoryColor3 = new Color(205, 205, 205, 255);
        }else {
            categoryColor = new Color(0, 0, 0, 80);
            categoryColor3 = new Color(0, 0, 0, 200);
        }
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof BooleanSetting) {
                ...
                int color = ColorUtil.interpolateColor(categoryColor, colors.getFirst(), (float) animation.getOutput().floatValue());
                ...
                RoundedUtil.drawRound(x + 109, settingY, 18, 8, 4, ColorUtil.interpolateColorC(categoryColor, colors.getFirst(), (float) animation.getOutput().floatValue()));
            ...
            if (setting instanceof ModeSetting) {
                ...
                RoundedUtil.drawRound(boxX, settingY - 1, modeWidth + 2, 12 + (float) (math * animation.getOutput().floatValue()), 4, categoryColor3);
                ...
                //      4, categoryColor3.getRGB());

                RoundedUtil.drawRound(x + 114 - stringWidth, settingY, modeWidth, 10 + (float) (math * animation.getOutput().floatValue()), 3, categoryColor);
            ...
            if (setting instanceof ColorSetting) {
                ...
                RoundedUtil.drawRound(x + 12, settingY - 1, 117, height, 4, categoryColor3);
                RoundedUtil.drawRound(x + 13, settingY, 115, height - 2, 3, categoryColor);
                //   RenderUtil.renderRoundedRect(x + 8.5f, settingY - 4.5f, 118, 85, 4, categoryColor3.getRGB());
                //  RenderUtil.renderRoundedRect(x + 10, settingY - 3, 115, 82, 3, categoryColor.getRGB());
                ...
                GL11.glEnable(GL11.GL_BLEND);
                RenderUtil.color(-1);
                mc.getTextureManager().bindTexture(new ResourceLocation("OnLooker/Images/colorpicker2.png"));
                ...
                // Hue bar
                RenderUtil.color(-1);
                mc.getTextureManager().bindTexture(new ResourceLocation("OnLooker/Images/hue.png"));
            ...
            if (setting instanceof NumberSetting) {
                ...
                RoundedUtil.drawRound(x + 12, settingY + 13, 110, 5, 2, categoryColor);
            ...
            if (setting instanceof StringSetting) {
                ...
                // RenderUtil.renderRoundedRect(x + 13, settingY - 3, 115, 40, 3, categoryColor.getRGB());
                ...
                textField.setOutline(categoryColor3);
                textField.setFill(categoryColor);
            ...
            if (setting instanceof MultipleBoolSetting) {
                ...
                RenderUtil.renderRoundedRect(x + 11.5f, settingY - 4.5f, 118, 19 + adjustment, 4, categoryColor3.getRGB());
                RenderUtil.renderRoundedRect(x + 13, settingY - 3, 115, 16 + adjustment, 3, categoryColor.getRGB());
