...
public class MultipleBoolComponent extends SettingComponent<MultipleBoolSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        RoundedUtil.drawRound(x + 5, boxY, width - 10, boxHeight + additionalHeight, ClickGUIMod.radius.getValue().floatValue() + 1, outlineColor);


        RoundedUtil.drawRound(x + 6, boxY + 1, width - 12, (boxHeight - 2) + additionalHeight, ClickGUIMod.radius.getValue().floatValue(), rectColor);
        ...
        for (BooleanSetting setting : sortedSettings) {
            ...
            RoundedUtil.drawRound(enabledX, enabledY, enabledWidth, enabledHeight, ClickGUIMod.radius.getValue().floatValue(), rectColorBool);
