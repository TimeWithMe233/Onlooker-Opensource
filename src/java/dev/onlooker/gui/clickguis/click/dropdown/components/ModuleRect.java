...
import dev.onlooker.gui.clickguis.click.dropdown.components.settings.*;
...
import dev.onlooker.utils.animations.impl.EaseOutSine;
...
public class ModuleRect implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        tenacityFont18.drawString((module.isEnabled() ? "§l" : "") + module.getName(), x + width / 2 - (tenacityBoldFont18.getStringWidth((module.isEnabled() ? "§l" : "") + module.getName())) / 2, y + tenacityBoldFont18.getMiddleOfBox(height), moduleTextColor);
        ...
        if (module.isExpanded() || !settingAnimation.isDone()) {
            ...
            Gui.drawRect2(x, y + height, width, (float) (settingHeight * settingRectHeight), new Color(settingRectColor.getRed(), settingRectColor.getGreen(), settingRectColor.getBlue(), 0).getRGB());
