...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    private final TextField hexField = new TextField(tenacityFont16);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            float radius = ClickGUIMod.radius.getValue().floatValue();
            ...
            GLUtil.startBlend();
            RenderUtil.drawImage(new ResourceLocation("OnLooker/Images/colorpicker2.png"), pickerX, pickerY, 4, 4);
            GLUtil.endBlend();
