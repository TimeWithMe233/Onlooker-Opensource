...
import static dev.onlooker.utils.misc.MathUtils.interpolateFloat;
import static dev.onlooker.utils.misc.MathUtils.interpolateInt;
...
public class ColorUtil {
    ...
    public static int getColor3(Color color1, Color color2, long ms, int offset) {
