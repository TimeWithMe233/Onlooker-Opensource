...
import dev.onlooker.utils.Location;
...
public class RotationUtils implements Utils {
    ...
    public static float[] getThrowRotation(final Entity entity, final double maxRange) {
        ...
        final double diffX = entity.posX - RotationUtils.mc.thePlayer.posX + entity.motionX;
        final double diffZ = entity.posZ - RotationUtils.mc.thePlayer.posZ + entity.motionZ;
