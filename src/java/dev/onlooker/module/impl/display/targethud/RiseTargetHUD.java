...
public class RiseTargetHUD extends TargetHUD {
    ...
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        setWidth(Math.max(128, FontManager.Naven20.getStringWidth("Name: " + target.getName()) + 60));
        setHeight(50);
        ...
        GlStateManager.color(1, 1, 1, 1);
        FontManager.GenShinGothic18.drawString(String.valueOf(healthNum), x + animatedHealthBar.getOutput() + 8, y + 38, textColor);
        GlStateManager.color(1, 1, 1, 1);
        FontManager.GenShinGothic20.drawString("Name: " + target.getName(), x + 40, y + 10, textColor);
        GlStateManager.color(1, 1, 1, 1);
        FontManager.GenShinGothic20.drawString("Distance: " + MathUtils.round(mc.thePlayer.getDistanceToEntity(target), 1) + " Hurt: " + target.hurtTime,
                x + 40, y + 22, textColor);
