...
public class ArrayListMod extends Module {
    public final MultipleBoolSetting hideModules = new MultipleBoolSetting("Importants",
            new BooleanSetting("Combat", true),
            new BooleanSetting("Movement", false),
            new BooleanSetting("Render", false),
            new BooleanSetting("World", false),
            new BooleanSetting("Player", false),
            new BooleanSetting("Display", false),
    ...
    public Dragging arraylistDrag = Client.INSTANCE.createDrag(this, "Arraylixst", 2, 1);
    ...
    public void onShaderEvent(ShaderEvent e) {
        ...
        for (Module module : modules) {
            if ((module.getCategory() == Category.RENDER && hideModules.isEnabled("Render")) || (module.getCategory() == Category.DISPLAY && hideModules.isEnabled("Display")) || (module.getCategory() == Category.MISC && hideModules.isEnabled("Misc")) || (module.getCategory() == Category.COMBAT && hideModules.isEnabled("Combat") || (module.getCategory() == Category.WORLD && hideModules.isEnabled("World")) || (module.getCategory() == Category.PLAYER && hideModules.isEnabled("Player")) || (module.getCategory() == Category.MOVEMENT && hideModules.isEnabled("Movement")))) continue;
    ...
    public void onRender2DEvent(Render2DEvent e) {
        ...
        for (Module module : modules) {
            ...
            if (background.isEnabled()) {
                ...
                Color color = backgroundColor.isEnabled() ? textcolor :color2;
                Gui.drawRect2(x - 2, y, font.getStringWidth(displayText) + offset, heightVal,
