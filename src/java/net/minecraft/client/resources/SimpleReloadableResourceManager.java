...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
    ...
    public void reloadResources(List<IResourcePack> p_110541_1_, boolean lang) {
        this.clearResources();
        ...
        this.notifyReloadListeners(lang);
    }
    ...
    private void notifyReloadListeners(boolean lang) {
        for (IResourceManagerReloadListener iresourcemanagerreloadlistener : this.reloadListeners) {
            if (lang && !(iresourcemanagerreloadlistener instanceof LanguageManager))
                continue;
