...
import dev.onlooker.event.impl.player.ContainerEvent;
...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Client.INSTANCE.isEnabled(ChestStealer.class) && ChestStealer.freeLook.getValue()  && mc.currentScreen instanceof GuiChest) {
