...
import dev.onlooker.gui.mainmenu.Welcome;
import dev.onlooker.module.ProtectedLaunch;
import dev.onlooker.module.impl.display.ClickGUIMod;
import dev.onlooker.module.impl.render.MotionBlur;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        FontUtil.setupFonts();
        SplashScreen.drawSplashScreen(0);
        ...
        SplashScreen.drawSplashScreen(2);
        ...
        SplashScreen.drawSplashScreen(4);
        this.textureMapBlocks = new TextureMap("textures");
        this.textureMapBlocks.setMipmapLevels(this.gameSettings.mipmapLevels);
        SplashScreen.drawSplashScreen(6);
        this.renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
        this.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
        SplashScreen.drawSplashScreen(8);
        ...
        SplashScreen.drawSplashScreen(10);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        this.guiAchievement = new GuiAchievement(this);
        SplashScreen.drawSplashScreen(12);
        ...
        if (this.serverName != null) {
            ...
            this.displayGuiScreen(new Welcome());
        }
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("OnLooker/16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("OnLooker/32.png"));
    ...
    public void refreshResources(boolean lang) {
        ...
        try {
            this.mcResourceManager.reloadResources(list, lang);
    ...
    public int getLimitFramerate() {
        return this.theWorld == null && this.currentScreen != null ? 165 : this.gameSettings.limitFramerate;
    }
...
//                        this.playerController.attackEntity(this.thePlayer, this.objectMouseOver.entityHit);
    ...
    public void rightClickMouse() {
        ...
        if (!this.playerController.getIsHittingBlock()) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY:
                        if (this.playerController.isPlayerRightClickingOnEntity(this.thePlayer, MovingObjectPosition.entityHit, this.objectMouseOver)) {
                            flag = false;
    ...
    public void runTick() throws IOException {
        ...
        try {
            if (Minecraft.getMinecraft().thePlayer != null && Shaders.configAntialiasingLevel == 0) {
                MotionBlur motionBlur = Client.INSTANCE.getModuleCollection().getModule(MotionBlur.class);
    ...
    public ListenableFuture<Object> scheduleResourcesRefresh() {
        return this.addScheduledTask(() -> this.refreshResources(false));
    }
