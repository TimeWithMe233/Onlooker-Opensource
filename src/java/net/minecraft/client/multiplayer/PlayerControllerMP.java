...
public class PlayerControllerMP {
     ...
     */
    public boolean onPlayerDestroyBlock(BlockPos pos, EnumFacing side) {        if (this.currentGameType.isAdventure()) {
            ...
            if (!this.mc.thePlayer.isAllowEdit()) {
                ...
                ItemStack itemstack = mc.thePlayer.inventory.alternativeSlot ? SlotComponent.getItemStack() : mc.thePlayer.getHeldItem();
        ...
        if (this.currentGameType.isCreative() && this.mc.thePlayer.getHeldItem() != null && this.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword) {
            ...
            if (block1.getMaterial() == Material.air) {
                ...
                if (!this.currentGameType.isCreative()) {
                    ItemStack itemstack1 = mc.thePlayer.inventory.alternativeSlot ? SlotComponent.getItemStack() : mc.thePlayer.getHeldItem();
